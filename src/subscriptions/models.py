...
class Subscription(models.Model):
    ...
    subtitle = models.TextField(help_text="Add subtitle for the subscription", blank=True, null=True)
...
class UserSubscription(models.Model):
    ...
    @property
    def plan_name(self):
        if not self.subscription: return None
        return self.subscription.name
